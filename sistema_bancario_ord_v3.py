...
def cadastrar_conta():
    ...
    valida_conta = conta in cadastro_contas
    if valida_conta == False:
        cadastro_contas.update({conta:{"cliente":cpf,"agencia":agencia}})
...
while True:
    ...
    if opcao == "c1":
        ...
        print(f"Obrigado por utilizar nossos serviços. Volte sempre!!!")
        break
